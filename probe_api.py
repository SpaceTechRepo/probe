...
class ProbeAPI:
    ...
    def run_commands(self, command_str):
        ...
        * load loads a series of thrust commands, each command in the format [Delta v [Km/s],angle [rad],t [days]]
        ...
        * land loads a landing command which takes the approach velocity in Km/s as an argument
        *   example load command: fuel 50;
        ...
        *   load [[82, 78, 77], [86, 65, 96], [32, 99, 108], [86, 67, 109], [111, 119, 110]]; fuel 0.5; start;
